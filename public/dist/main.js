...
window.addEventListener("DOMContentLoaded", function () {
  document.getElementById("app").innerText = "Hello World!"; // let testLocation = "Germany";
  ...
  axios.get("/objects/all").then(function (response) {
    debugger;
    console.log(response);
  });
});
